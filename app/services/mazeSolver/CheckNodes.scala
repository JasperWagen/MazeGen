...
class CheckNodes {
    ...
    def checkPossibleNodes(maze: Array[Array[Int]], position: (Int, Int), delta: (Int, Int)): Option[(Int, Int)] ={
        val (j, i) = position
    ...
    def checkVisitedNodes(visitedNodes: Array[Array[Int]], position: (Int, Int)): Option[(Int, Int)] = {
        val (j, i) = position
        try {
    ...
    def checkAvailableNodes(maze: Array[Array[Int]], visitedNodes: Array[Array[Int]], position: (Int, Int)): List[(Int, Int)] = {
